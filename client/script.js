...
const registerUser = (userName, email, password) => {
    axios.post('http://localhost:49160/api/v1/user', {userName, email, password} )
    .then(response => {
...
const loginUser = (email, password) => {
    ...
    axios.post('http://localhost:49160/api/v1/login', { email, password} )
    .then(response => {
        const loginUser = response.data.data;
        console.log(`GET loginUser`, response);
    })
    .catch(error => console.error(error));
